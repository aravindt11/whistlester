...
static NSString * const kTakePhotoKey = @"Take Photo";
static NSString * const kTakeVideoKey = @"takeVideo";
static NSString * const kChooseFromLibraryKey = @"Choose From Library";
...
- (UIImagePickerController *)imagePicker
{
    if (!_imagePicker) {
        ...
        _imagePicker.navigationBar.barTintColor=[UIColor peterRiverColor];
